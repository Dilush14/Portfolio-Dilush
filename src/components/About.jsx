        ...
        <div className='max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center'>
            ...
            >
                <div className='relative w-75 h-75 lg:w-96 lg:h-96'>
                    {/* Image */}
                    <div className='absolute -inset-6 lg:-inset-20 bg-linear-to-l from-[#fb923c] to-[#f59e0b] rotate-12 star-shape z-0'
                    data-aos='zoom-in'
                    data-aos-delay='600'
                    >
                    </div>
            ...
            >
                ...
                data-aos-delay='500'
                >
                    I am passionate about full-stack development and enjoy building efficient, scalable, and user-friendly applications. My interests include both front-end and back-end development, where I focus on writing clean code and creating smooth user experiences.
                </p>
                <p
                className={`text-sm  sm:text-base lg:text-lg xl:text-xl mb-6 sm:mb-8 leading-relaxed bg-linear-to-r from-orange-900/10 to-orange-900/5 p-4 sm:p-6 rounded-xl sm:rounded-2xl backdrop-blur-sm
                    ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}
                ...
                data-aos-delay='600'
                >
                    I’m constantly learning new technologies and improving my problem-solving skills through hands-on projects. I enjoy turning ideas into real-world solutions and am currently seeking an internship opportunity where I can grow as a developer and contribute to meaningful projects.
                </p>
                ...
                <button
                className={`w-full sm:w-auto inline-flex items-center justify-center cursor-pointer border-2 border-orange-500 py-2 px-4 sm:px-6 hover:shadow-[0_0_40px_rgb(255,165,0,0.7)] rounded-full text-base sm:text-lg font-semibold transition-all duration-300 transform
